                ...
                <div className="flex flex-col gap-6 mt-5 items-start">
                    <div className="flex items-center gap-2">
                        <span>
                            ...
                            <label htmlFor="md"
                                className={`${shoeSize == "MD" && "bg-custom-yellow text-custom-gray-secondary"} border border-custom-yellow text-custom-yellow font-semibold py-2 px-4 rounded cursor-pointer`}
                            >
                                MD
                            </label>
                        </span>
                        <span>
                            ...
                            <label htmlFor="xl"
                                className={`${shoeSize == "XL" && "bg-custom-yellow text-custom-gray-secondary"} border border-custom-yellow text-custom-yellow font-semibold py-2 px-4 rounded cursor-pointer`}
                            >
                                XL
                            </label>
                        </span>
                        <span>
                            ...
                            <label htmlFor="2xl"
                                className={`${shoeSize == "2XL" && "bg-custom-yellow text-custom-gray-secondary"} border border-custom-yellow text-custom-yellow font-semibold py-2 px-4 rounded cursor-pointer`}
                            >
                                2XL
                            </label>
                        </span>
